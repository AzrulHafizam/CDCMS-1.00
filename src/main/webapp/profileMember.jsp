        ...
        <script>
            function confirmDelete(activityId) {
                ...
                if (confirmation === true) {
                    window.location.href = "deletehc?member_id=" + member_id;
                } else {
                    window.location.href = "viewhc?member_id=" + member_id;
                }
            }
        </script>
    </head>
    <body>
        ...
        <main style="background-color: white;
            ...
            <table>
                ...
                <tr>
                    <td>Phone Number</td>
                    <td><c:out value="${member.member_phonenum}"/></td>
                </tr>
                <tr>
                    <td>Password</td>
                    <td><c:out value="${member.member_password}"/></td>
                </tr>
                <tr>
                    <td>Body Number</td>
